...
- `SectionNoteSuggestModal` constructor takes an options object `{ placeholder, onPick, onSkip?, onDrop?, onOpenSource?, onCancel? }`; virtual sentinels appear only when their callback is provided.
