...
describe("sdd_erinnerungen-triage p2 c2: complete removes reminder line", () => {
	it("removes the completed reminder line, keeps the other, and advances counts/index", async () => {
		...
		expect(content).toContain("- Angebot prüfen");
