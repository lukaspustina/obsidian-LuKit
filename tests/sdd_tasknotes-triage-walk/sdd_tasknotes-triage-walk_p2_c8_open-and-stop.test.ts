...
describe("TaskTriageFeature.handleOpenAndStop", () => {
	it("opens the first task, stops the walk, and reports it in remaining", async () => {
		...
		const { internals } = setup(fakeBridge({ openInNewTab, listTasks }));
